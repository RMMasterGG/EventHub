...
import com.semasem.dto.entity.WebSocketAction;
...
public class WebSocketChatController extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        try {
            ...
            broadcastToRoom(roomId, createSystemMessage(user.getName() + " joined the chat", ParticipantStatus.JOINED));
        ...
        if (roomId != null && userId != null) {
            ...
            try {
                ...
                broadcastToRoomExceptUserSafe(roomId, userId,
                        createSystemMessage(user.getName() + " left the chat", ParticipantStatus.LEFT));
            } catch (Exception e) {
